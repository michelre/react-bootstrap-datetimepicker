...
var DateTimePickerMonths = (function (_Component) {
  ...
  function DateTimePickerMonths() {
    ...
    this.renderMonths = function () {
      ...
      _minDate = !minDate ? (0, _moment2["default"])(0) : minDate.clone().startOf('month');
      _maxDate = !maxDate ? (0, _moment2["default"])({ y: 2999 }) : maxDate.clone().startOf('month');
      i = 0;
      months = [];
      while (i < 12) {
        var current = (0, _moment2["default"])(i + 1, 'M').year(_this.props.viewDate.year());
        classes = {
          month: true,
